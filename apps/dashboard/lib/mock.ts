...
export const MOCK_ASSESSMENTS = [
  { id: 'as1', candidateName: 'Juan Pérez', type: 'Prueba Comercial', competency: 'Venta consultiva', score: 90, result: 'Aprobado' },
  { id: 'as2', candidateName: 'Juan Pérez', type: 'Role Play', competency: 'Negociación', score: 85, result: 'Aprobado' },
  { id: 'as3', candidateName: 'Ana Gómez', type: 'Prueba Conductual', competency: 'Resiliencia', score: 78, result: 'Aprobado' },
  { id: 'as4', candidateName: 'Carlos Ruiz', type: 'Prueba Comercial', competency: 'Planeación', score: 72, result: 'En revisión' },
];
...
export const MOCK_CALENDAR = [
  { id: 'cal1', title: 'Entrevista Ana Gómez', type: 'Entrevista', date: new Date(Date.now() + 1 * 86400000).toISOString() },
  { id: 'cal2', title: 'Discovery Distribuidora Andina', type: 'Discovery', date: new Date(Date.now() + 2 * 86400000).toISOString() },
  { id: 'cal3', title: 'Presentación finalistas TechSales', type: 'Reunión', date: new Date(Date.now() + 4 * 86400000).toISOString() },
];
...
export const MOCK_REPORTS = {
  ...
  avgTimePerStage: [
    { stage: 'Filtro', days: 3 },
    { stage: 'Entrevista', days: 5 },
    { stage: 'Prueba', days: 4 },
    { stage: 'Cliente', days: 6 },
    { stage: 'Oferta', days: 3 },
  ],
  byConsultant: [
    { name: 'María Consultora', vacancies: 3, hires: 2 },
    { name: 'Admin Kova', vacancies: 1, hires: 0 },
  ],
  sources: [
    { source: 'LinkedIn', count: 8 },
    { source: 'Referido', count: 5 },
    { source: 'Computrabajo', count: 3 },
    { source: 'Elempleo', count: 2 },
  ],
  hiresByMonth: [
    { month: 'Ene', hires: 1 },
    { month: 'Feb', hires: 2 },
