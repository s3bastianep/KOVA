...
export const CLIENT_JOURNEY_STAGES: ClientJourneyStage[] = [
  ...
  },
  {
    id: 'pre_interview',
    order: 5,
    label: 'Entrevista precandidatos',
    shortLabel: 'Pre-entrevista',
    description: 'Filtrar aspirantes antes de presentarlos al cliente.',
    color: '#D97706',
    bg: '#FFF7E6',
  },
  {
  ...
  },
  {
    id: 'onboarding',
    order: 8,
    label: 'Selección + Onboarding + Estandarización',
    shortLabel: 'Onboarding',
    description: 'Contratación, ingreso y estandarización comercial.',
    color: '#00B27A',
    bg: '#E6FAF3',
  },
];
