...
function countRecommendedVacancies(
  candidate: { metadata?: unknown; city?: string | null },
  openVacancies: { id: string; metadata: unknown }[],
...
export async function GET(req: NextRequest) {
  return handlePortalRoute(
    ...
    const [aplicacionesActivas, entrevistasProximas, appliedRows, openVacancies] = await Promise.all([
    ...
    const vacantesRecomendadas = countRecommendedVacancies(candidate, openVacancies, appliedIds);
